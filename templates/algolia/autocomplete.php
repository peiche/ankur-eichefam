		...
		<div class="wp-block-post post type-post status-publish has-post-thumbnail hentry">
			<# if ( img ) { #>
				<figure class="wp-container-13 wp-block-post-featured-image">
					<img class="attachment-post-thumbnail size-post-thumbnail wp-post-image" style="object-fit:cover;aspect-ratio: 710/508;" 
						loading="eager"
						src="{{ img }}" 
			...
			<# } #>
			<h2 class="wp-block-post-title has-md-font-size">
				{{{ data._highlightResult.post_title.value }}}
			</h2>
			<div class="wp-block-post-excerpt">
				<p class="wp-block-post-excerpt__excerpt" style="margin-bottom: 0;">
